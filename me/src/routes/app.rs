...
pub fn app() -> Html {
    html! {
        <div class="flex min-h-screen bg-black">
            <aside class="hidden md:flex md:flex-col md:w-64 bg-neutral-900 p-6">
                ...
                <nav class="flex flex-col gap-4">
                    <a href="https://github.com/myferr" target="_blank" class="text-[#e5e5e5] underline">{"github"}</a>
                    <a href="https://x.com/myferdoescoding" target="_blank" class="text-[#e5e5e5] underline">{"x dot com"}</a>
                    <a href="/blog" class="text-[#e5e5e5] underline">{"blog"}</a>
                </nav>
            </aside>
